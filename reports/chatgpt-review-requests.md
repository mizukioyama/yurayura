...
- Artistsスライドショーは、スマホ時の親セクション左右44px paddingを相殺したうえで、表示領域・1枚のカードが各viewport幅になり、内部トラックが無限ループ幅であることを確認
...
- 全sectionの左右Paddingが320/390/700/1024pxで44pxになっていることを確認
