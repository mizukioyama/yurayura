...
- [x] FAQの購入・発送・領収書関連カテゴリを削除した
- [x] 「展示について」を追加した
- [x] 「お問い合わせ」を追加した
- [x] 既存の期間・アクセス・主催者情報を維持した
- [x] 追加したFAQを開いて回答を確認した
- [x] 公開Topで新しいFAQ内容を確認した
- [x] 編集前バックアップを保存した
- [ ] スマートフォン実機とキーボード操作を確認する

## FAQ answer wording and contact category removal (2026-09-12)

- [x] FAQの全回答を説明口調へ変更した
- [x] FAQ内の「お問い合わせ」カテゴリを削除した
- [x] 期間・アクセス・展示・主催者の4カテゴリを維持した
- [x] Contactフォームを変更していない
- [x] 公開Topで回答文とカテゴリ構成を確認した
- [x] FAQの開閉動作を確認した
- [x] 編集前バックアップを保存した
- [ ] スマートフォン実機とキーボード操作を確認する
...
- [x] FAQ回答だけを2px小さくした
- [x] `clamp`でレスポンシブ表示を維持した
- [x] 質問行・見出し・Contactフォームを変更していない
- [x] 公開Topで回答と質問行の計算値を確認した
- [x] 公開Topで回答の開閉表示を確認した
- [x] 編集前バックアップを保存した
- [ ] スマートフォン実機とキーボード操作を確認する
